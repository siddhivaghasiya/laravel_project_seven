   ...
   <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
       <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
           <a class="navbar-brand brand-logo mr-5" href="{{ route('admin') }}"><img
                   src="{{ asset('theme/images/logo.svg') }}" class="mr-2" alt="logo" /></a>
           <a class="navbar-brand brand-logo-mini" href="{{ route('admin') }}"><img
                   src="{{ asset('theme/images/logo-mini.svg') }}" alt="logo" /></a>
       </div>
   ...
   <div class="container-fluid page-body-wrapper">
       ...
       <nav class="sidebar sidebar-offcanvas" id="sidebar">
           <ul class="nav">
               ...
               <li class="nav-item">
                   <a class="nav-link" data-toggle="collapse" href="#Common-Modules" aria-expanded="false"
                       aria-controls="Common-Modules">
                   ...
                   <div class="collapse" id="Common-Modules">
                       <ul class="nav flex-column sub-menu">
                           ...
                           <li class="nav-item"> <a class="nav-link" href="{{ route('email.index') }}">Email
                                   Template</a></li>
                           <li class="nav-item"> <a class="nav-link" href="{{ route('social_media.index') }}">Social
                                   Media</a></li>
                           <li class="nav-item"> <a class="nav-link" href="{{ route('contact_us.index') }}">Contact
                                   Us</a></li>
                           <li class="nav-item"> <a class="nav-link"
                                   href="{{ route('newslater.index') }}">NewsLetter</a></li>
                       </ul>
                   </div>
               </li>
               ...
               <li class="nav-item">
                   <a class="nav-link" data-toggle="collapse" href="#ui-basicc" aria-expanded="false"
               ...
               <li class="nav-item">
                   <a class="nav-link" data-toggle="collapse" href="#ui-basiccc" aria-expanded="false"
